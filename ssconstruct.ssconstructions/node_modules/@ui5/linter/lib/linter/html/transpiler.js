...
export default async function transpileHtml(resourcePath, contentStream, context) {
    try {
...
function detectTestStarter(resourcePath, scriptTags, report) {
...
function findBootstrapTag(tags) {
...
function lintBootstrapAttributes(tag, report) {
    const attrCollection = new Map();
...
function checkPreloadAttr(attr, report) {
...
function checkOriginInfoAttr(attr, report) {
...
function checkBindingSyntaxAttr(tag, attr, report, compatVersionAttr) {
...
function checkThemeAttr(attr, report) {
...
function checkLibraryAttr(attr, report, modulesSyntax = false) {
...
function checkAsyncAttr(attr, report) {
...
function checkCompatVersionAttr(attr, report) {
...
function checkOnInitAttr(attr, report) {
