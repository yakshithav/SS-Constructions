...
export default class SourceFileLinter {
    ...
    fixHelpers;
    resourcePath;
    constructor(typeLinter, sourceFile, checker, reportCoverage = false, messageDetails = false, apiExtract, filePathsWorkspace, workspace, ambientModuleCache, fixFactory, manifestContent, libraryDependencies, metadataCollector) {
    ...
    async lint() {
        try {
            ...
            this.typeLinter.getContext().addLintingMessage(this.resourcePath, { id: MESSAGE.PARSING_ERROR, args: { message } });
        }
    }
    visitNode(node) {
