...
export default function rewriteExtendCall(nodeFactory, callExp, modifiers, className) {
    ...
    const classDecl = nodeFactory.createClassDeclaration(modifiers, className, undefined, [nodeFactory.createHeritageClause(ts.SyntaxKind.ExtendsKeyword, [nodeFactory.createExpressionWithTypeArguments(callExp.expression.expression, undefined)])], body);
    if (classNamespace) {
...
function getClassNameFromArgument(classNameNode) {
...
//# sourceMappingURL=rewriteExtendCall.js.map